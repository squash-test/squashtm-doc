...
### ![Ancre Informations](icone_linked_requierement.png)  nce isnce is bloc 'Exigences liées' permet d'associer des exigences à l'exigence consultée. Une table affiche les informations des exigences liées.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM1NDMwMjA3NSwtMTU4Njc1MzkzNCwxND
