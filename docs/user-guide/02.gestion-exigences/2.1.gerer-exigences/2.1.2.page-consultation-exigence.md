...
L'ajout d'une nouvelle version de l'exigence icne depuis ce bouton![Ancre Informations](resources/via cette icôone ou_more.png) ou l'ajout d'une pièce jointe est possible via les boutons situés en haut à droite de la page : [Icone_attachement et La barre des ancres à gauche, permet au clic sur une ancre, d'accéder au bloc correspondant :
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1ODY3NTM5MzQsLTY2MjAwOTI2MCwxND
