...
Le bloc 'Indicateur de couverture' présente les indicateurs suivants  (voir Suivi de la couverture et des exécutions [Titre du lien](**../Dossier3/fichier3.md**)):
...
!!! tip "En savoir plus"
	Faire un renvoi vers une autre page (couleur verte). Pour compléter un fichier d'import, consulter les pages *Liens vers "Renseigner un fichier d'import d'exigences" et "Renseigner un fichier d'import de cas de test"* 
...
### ![Ancre Exigences liees](resources/icone_linked_requierements.png) Exigences liées
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgyOTQxMzk1OSwtMTQyNTQ5OTU5LC00OT
M2NDY5MTksLTg1MTA4NTEwLDg2MzYxNTMxMSwxMTYyNjcyODc5
LDE5NjcxMzk4MzIsLTUwNjk2NzY3MywtMTk2Mzc5OTk4OCwxNT
