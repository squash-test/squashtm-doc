...
!!! tip "En savoir plus"
	Pour plus de détails, consulter la partie [Suivi de la couverture](**../../02.gestion-exigences/2.4.suivi-couverture/2.4.suivi-couverture.md](https://github.com/squash-test/squashtm-doc/blob/main/docs/user-guide/02.gestion-exigences/2.4.suivi-couverture/2.4.suivi-couverture.md "2.4.suivi-couverture.md")**)

### ![Ancre cas de test vrifiant cette exigence](resources/icone_linked_test_cases.png) Cas de test vérifiant cette exigence
...
### ![Ancre Exigences lies](resources/icone_linked_requierements.png)Exigences liées
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjcyOTMwNTUwLC00MTY4MzQ0NDYsMTY1ND
QzNDY0NiwtMzQxOTUxMzAwLC0xNDI1NDk5NTksLTQ5MzY0Njkx
OSwtODUxMDg1MTAsODYzNjE1MzExLDExNjI2NzI4NzksMTk2Nz
