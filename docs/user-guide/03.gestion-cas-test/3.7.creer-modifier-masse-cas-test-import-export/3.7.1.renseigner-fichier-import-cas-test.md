...
!!! info "Info"
	...
	<br/>Un gabarit d'import est téléchargeable depuis la popup d'import dans l'espace Cas de test.
...
| TC_WEIGHT  | Code de l’importance du cas de test. <br/> Si TC_WEIGHT_AUTO = 1, la valeur indiquée pour TC_WEIGHT est ignorée.                                                                                                                                                                                                                                                                                                     | - VERY_HIGH<br/>- HIGH<br/>- MEDIUM<br/>- LOW [valeur par défaut]                                                                                |
| TC_NATURE | Code de la nature du cas de test                                                                                                                                                                                                                                                                                                                       | - NAT_ATDD<br/>- NAT_BUSINESS_TESTING<br/>- NAT_NON_FUNCTIONAL_TESTING<br/>- NAT_PERFORMANCE_TESTING<br/>- NAT_SECURITY_TESTING<br/>- NAT_UNDEFINED [valeur par défaut]<br/>- NAT_USER_TETSTING              |
| TC_TYPE   | Code du type de cas de test                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | • TYP_COMPLIANCE_TESTING  • TYP_CORRECTION_TESTING  • TYP_END_TO_END_TESTING  • TYP_EVOLUTION_TESTING  • TYP_PARTNER_TESTING  • TYP_REGRESSION_TESTING • TYP_UNDEFINED (valeur par défaut si non renseignée) |
| TC_STATUS    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | • APPROVED  • OBSOLETE  • TO_BE_UPDATED  • UNDER_REVIEW • WORK_IN_PROGRESS (valeur par défaut si non renseignée) |
| TC_DESCRIPTION  | Description du cas de test 
|      |
| TC_PRE_REQUISITE | Prérequis du cas de test                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |  |
| TC_CREATED_ON | Date de création du cas de test. Les dates sont exportées dans des cellules de type date dans le fichier Excel. Pour l’import elles doivent être renseignées dans des cellules de type date ou de type texte au format ISO 8601 (yyyy-mm-dd ).Si elle n’est pas renseignée, utiliser la date courante.                                                                                                                                                                                              | Format : YYYY-MM-DD                                                                                                                                                                                          |
| TC_CREATED_BY   | Login du créateur. Pour l’import, si non renseigné, prendre le login de l’utilisateur qui réalise l’import.                                                                                                                                                                                                                                                                                                                                                                                         | |
| *TC_LAST_MODIFIED_ON* | *Date de dernière modification du cas de test (colonne ignorée si présente dans le fichier d’import)*                                                                                                                                                                                                                                                                                                                                                                                                |    |
| *TC_LAST_MODIFIED_BY*  | *Login du dernier modificateur. Les dates sont exportées dans des cellules de type date dans le fichier Excel. (colonne ignorée si présente dans le fichier d’import)*                                                                                                                                                                                                                                                                                                                              |      |
| TC_KIND              | Code du format du cas de test : Si non renseigné le cas de test est importé comme un cas de test classique.                                                                                                                                                                                                                                                                                                                                                                                         | Format• STANDARD  • GHERKIN  • KEYWORD                                                                                                                                                                       |
| TC_SCRIPT            | • Script Gherkin du cas de test                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |    |
| TC_AUTOMATABLE       | Eligibilité à l’automatisation du cas de test :                                                                                                                                                                                                                                                                                                                                                                                                                                                     | • M : A instruire  • Y : Eligible • N : Non éligible                                                                                                                                                         |
| TC_CUF_<cuf code>    | La valeur du champ personnalisé de code <code du cuf\> pour le cas de test.                                                                                                                                                                                                                                                                                                                                                                                                                          |                                                                                           |
...
| TC_STEP_NUM              | Numéro d’ordre de l’étape de test (commence à 1) <br/>Pour l’import, les numéros peuvent ne pas se suivre : on prend l’ordre relatif entre les différents TC_STEP_NUM. <br/>Si deux steps ont le même numéro d’ordre, ils sont numérotés dans l’ordre dans lequel ils apparaissent dans le fichier. <br/>Si la valeur est absente de l’import, les steps sont numérotés dans l’ordre d’apparition dans le fichier d’import. |
| TC_STEP_IS_CALL_STEP     | Pour l’import, si ce champ n’est pas renseigné, la valeur par défaut à prendre en compte est "0".| - "0" si l’étape est une action step <br/>- "1" si l’étape est une call step. |
...
| TC_STEP_EXPECTED_RESULT  | - Résultat attendu pour l’étape si c’est une action step (qui peut contenir des balises HTML). <br/>- Si STEP_IS_CALL_STEP = 1, cette colonne est ignorée (au cas où elle serait tout de même présente dans le fichier d’import)                                                                                                                                    |
