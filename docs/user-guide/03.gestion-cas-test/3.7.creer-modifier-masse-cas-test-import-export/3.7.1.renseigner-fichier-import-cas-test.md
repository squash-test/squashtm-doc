...
- Si vous souhaitez importer un cas de test dans un dossier qui s'appellera "Dossier1" : dans le dossier zippé, il faudra créer le dossier "Dossier1"; puis à l'intérieur de ce dossier, placer le fichier Excel qui contiendra les informations du cas de test à importer
