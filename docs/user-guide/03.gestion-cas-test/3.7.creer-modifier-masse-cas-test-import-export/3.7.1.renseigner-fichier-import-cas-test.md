...
| TC_STATUS    |  Code du statut de rédaction du cas de test                                                                                                                                                                                                                                                                                                                                                                                                                                     | - APPROVED (Approuvé)<br/>- OBSOLETE (Obsolète)<br/>- TO_BE_UPDATED (A mettre à jour)<br/>- UNDER_REVIEW<br/>- WORK_IN_PROGRESS (En cours de rédaction) [Valeur par défaut] |
...
| TC_AUTOMATABLE       | Eligibilité à l’automatisation du cas de test                                                                                                                                                                                                                                                                                                                                                                                                                                                     | - M : A instruire<br/>- Y : Eligible<br/>- N : Non éligible                                                                                                                                                         |
