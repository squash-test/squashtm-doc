...
- Si vous souhaitez créer/importer 10 cas de test, il vous faudra 10 fichier Excel.
- Si vous souhaitez créer/importer un cas de test dans un dossier qui s'appellera "Dossier1" : dans le dossier zippé devra avoir comme nom "Dossier1", puis à l'intérieur de ce dossier, placer le fichier Excel qui contiendra les informations du cas de test à importer
