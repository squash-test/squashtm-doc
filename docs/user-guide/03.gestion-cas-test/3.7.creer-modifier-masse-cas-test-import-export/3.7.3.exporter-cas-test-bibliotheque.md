...
- Les cas de test appelés peuvent également être exportés même s'ils ne font pas partie de la sélection, en cochant la case "Inclure les cas de test appelés". Cependant, seuls les cas de test appelés des projets sur lesquels vous avez au moins un droit d'export seront exportés.
