...
!!! note "Info"
	Si le format .csv est sélectionné pour l'import, un seul onglet est exporté contenant les attributs du cas de test et les pas de test. <br/>Les paramètres, jeux de données et les associations avec des exigences ne sont pas exportés.
