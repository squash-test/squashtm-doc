...
- Les cas de test appelés peuvent également être exportés même s'ils ne font pas partie de la sélection, en cochant la case "Inclure les cas de test appelés". Cependant, le droit d'export sur le projet exporté est nécessaire pour que les cas de test appelés soient inclus dans le fichier.
