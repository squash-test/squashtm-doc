...
Le bloc 'Cas de test appelé par' affiche le ou les cas de test qui appelle(nt) le cas de test en cours. Un cas de test appelé pourra être utilisé au sein d'un autre projet, d'un autre cas de test. Une table affiche les informations des cas de test "appelant".
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1OTkyNzQ2LDk0MDM1NDQ2NiwtMjA5Nz
