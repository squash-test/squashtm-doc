...
Il est possible d'exporter le cas de test via le bouton [Exporter] ou d'y ajouter une pièce jointe via le bouton ![Ajouter une pièce-jointe](resources/add-attachments.png) en haut à droite de la page. 
