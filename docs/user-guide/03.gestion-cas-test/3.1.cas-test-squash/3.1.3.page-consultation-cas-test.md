...
Au lieu de renseigner une valeur dans le bloc "Action" ou dans le bloc "Résultat attendu", il est possible de renseigner un paramètre qui pourra prendre une ou plusieurs valeurs (jeux de données). Les paramètres renseignés dans les pas de test seront automatiquement reportés dans le tableau des paramètres de l'onglet ‘Paramètres'. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3OTE0NjM3NjYsOTQwMzU0NDY2LC0yMD
