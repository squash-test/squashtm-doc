...
Le bloc 'Paramètres et jeux de données' permet d'ajouter des paramètres et des jeux de données au cas de test. Une table affiche le détail de chaque jeu de donnée.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwOTgyNjU3ODQsOTQwMzU0NDY2LC0yMD
