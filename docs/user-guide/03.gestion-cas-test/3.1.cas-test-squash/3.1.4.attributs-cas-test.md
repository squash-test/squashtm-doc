...
## Référence
La référence du cas de test est facultative, néanmoins elle permet d'organiser son référentiel. Des conventions de nommages doivent être définies pourorganiser rapidement les cas de test.
...
## Type
Le champ 'Type' permet de préciser le type du cas de test ('Non définie' par défaut). Le type peut être modifié à l'aide de la liste déroulante. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzODYyOTkxMywtOTU3MDE3MjQ1LDIxMT
