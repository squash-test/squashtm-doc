...
Depuis les espaces Exigences, Cas de test et Campagnes, le bouton ![Importer/Exporter](resources/icone-import-export.png) (Importer/Exporter) affiche un sous-menu permettant d'accéder aux fonctionnalités d'import/export.
...
!!! info "En savoir plus"
    ...
    [renseigner un fichier d'import exigences](../../2.gestion-exigences/2.6.creer-modifier-en-masse-exigences-import-export/2.6.1.renseigner-fichier-import-exigences.md)
...
2. Survoler le bouton ![Exporter](resources/icone-export-campagne.png) (Exporter)
